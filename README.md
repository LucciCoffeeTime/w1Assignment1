...
EXTRA INFO: The program forces users to meet input requirements through looping. At mostly every looping point, the user can freely exit a loop and the program if desired.
...
(STEP 7): The program will open a file named "report.txt" and write a pretty summary of all information provided and the calculated values (this acts as a form of documentation).
